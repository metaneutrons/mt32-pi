...
Entries from 0.14.0 onwards are generated by release-please from the commit
history. Everything below 0.13.1 was written by hand in the upstream project,
and its compare links point there because those releases live there.

## [0.14.1](https://github.com/metaneutrons/mt32-pi/compare/v0.14.0...v0.14.1) (2026-09-10)


### Bug Fixes

* **applemidi:** bound the session name by the received packet size ([#15](https://github.com/metaneutrons/mt32-pi/issues/15)) ([5630ffe](https://github.com/metaneutrons/mt32-pi/commit/5630ffe85a1790875ad2ed8091a6a168213b3cd4))
* **control:** report that buttons and encoders are unsupported on the Pi 5 ([#17](https://github.com/metaneutrons/mt32-pi/issues/17)) ([8f2a535](https://github.com/metaneutrons/mt32-pi/commit/8f2a5356803b8177138a4b4dc501be56b74a6776))
* **midi:** report short writes on the MIDI thru path ([#16](https://github.com/metaneutrons/mt32-pi/issues/16)) ([7b17718](https://github.com/metaneutrons/mt32-pi/commit/7b17718c9076844f31d2eaf1aa5ec9dd5fd98a0f))
* **mt32pi:** close the UI task shutdown race and drain the log without a 16 KiB frame ([#20](https://github.com/metaneutrons/mt32-pi/issues/20)) ([04d9ac7](https://github.com/metaneutrons/mt32-pi/commit/04d9ac751a0e6180fb3ce2734e8896a51bdf0a8d))
* **utility:** swap objects by move instead of relocating them byte-wise ([#19](https://github.com/metaneutrons/mt32-pi/issues/19)) ([53d9fa1](https://github.com/metaneutrons/mt32-pi/commit/53d9fa18ab9392d8e36a6445c00f33c89a1bb89d))
